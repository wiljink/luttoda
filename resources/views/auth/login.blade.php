    ...
    <div class="relative overflow-hidden bg-white rounded-2xl shadow-xl shadow-emerald-900/10 border border-emerald-900/5">
        ...
        <div class="px-6 py-6 sm:px-8 sm:py-7">
            ...
            <div class="flex flex-col items-center mb-5">
                <div class="w-14 h-14 flex items-center justify-center mb-3 rounded-full bg-emerald-50 ring-4 ring-amber-400/30 p-2.5">
                    <img src="{{ asset('images/jeepney.png') }}" alt="Luttoda Jeepney Cooperative" class="w-full h-full object-contain drop-shadow-sm">
                </div>
                <h1 class="text-xl font-bold text-emerald-900 tracking-tight">Welcome</h1>
            ...
            @if ($errors->any())
                <div class="mb-4 rounded-xl bg-red-50 border border-red-100 px-4 py-3 flex gap-3" role="alert" aria-live="assertive">
                    <svg class="w-5 h-5 text-red-500 flex-shrink-0 mt-0.5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M12 9v3.75m9-.75a9 9 0 11-18 0 9 9 0 0118 0zm-9 3.75h.008v.008H12v-.008z" />
                    </svg>
                    <div>
                        <p class="text-sm text-red-700 font-medium leading-5">
            ...
            <form method="POST" action="{{ route('login') }}" x-data="{ submitting: false }" @submit="submitting = true" class="space-y-4">
                ...
                <div>
                    ...
                    <div class="relative group">
                        <span class="absolute inset-y-0 left-0 flex items-center pl-3.5 text-gray-400 pointer-events-none transition-colors group-focus-within:text-emerald-600">
                        ...
                        <input
                            id="email"
                            class="block w-full pl-11 pr-4 py-3 text-base rounded-xl border-gray-200 bg-gray-50 shadow-sm transition focus:bg-white focus:border-emerald-500 focus:ring-emerald-500 focus:ring-2 {{ $errors->has('email') ? 'border-red-300 focus:border-red-500 focus:ring-red-500' : '' }}"
                            type="email"
                            name="email"
                ...
                <div x-data="{ show: false }">
                    ...
                    <div class="relative group">
                        ...
                        <input
                            id="password"
                            class="block w-full pl-11 pr-14 py-3 text-base rounded-xl border-gray-200 bg-gray-50 shadow-sm transition focus:bg-white focus:border-emerald-500 focus:ring-emerald-500 focus:ring-2 {{ $errors->has('password') ? 'border-red-300 focus:border-red-500 focus:ring-red-500' : '' }}"
                ...
                <div class="flex items-center justify-between">
                    <label for="remember_me" class="inline-flex items-center cursor-pointer select-none py-1">
                        ...
                        <span class="ms-2.5 text-sm text-gray-700">Keep me signed in</span>
                    </label>

                    @if (Route::has('password.request'))
                        <a class="text-sm font-medium text-emerald-700 hover:text-emerald-800 transition-colors" href="{{ route('password.request') }}">
                            Forgot password?
                        </a>
                    @endif
                </div>
                ...
                <button
                    ...
                    class="w-full inline-flex items-center justify-center gap-2 rounded-xl border border-transparent bg-emerald-700 px-4 py-3.5 text-base font-semibold text-white shadow-md shadow-emerald-900/20 transition focus:outline-none focus:ring-2 focus:ring-emerald-600 focus:ring-offset-2"
                >
